...
After training the YOLOv5-large model on our custom dataset, we evaluated its ability to detect key fashion elements.

Here are sample visualizations of object detection outputs on test images. The model successfully detects and classifies fashion items with high accuracy across varying poses, scales, and occlusions.

<br>
<center>
  <div style="display: flex; justify-content: center; gap: 10px;">
    <img src="utils/results/1.jpg" alt="da 1" style="height: 600px; width: 30%; object-fit: cover;">
    <img src="utils/results/2.jpg" alt="da 2" style="height: 600px; width: 30%; object-fit: cover;">
    <img src="utils/results/3.jpg" alt="da 3" style="height: 600px; width: 30%; object-fit: cover;">
  </div>
</center>
<br>
<center>
  <div style="display: flex; justify-content: center; gap: 10px;">
    <img src="utils/results/4.jpg" alt="da 1" style="height: 600px; width: 30%; object-fit: cover;">
    <img src="utils/results/5.jpg" alt="da 2" style="height: 600px; width: 30%; object-fit: cover;">
    <img src="utils/results/6.jpg" alt="da 3" style="height: 600px; width: 30%; object-fit: cover;">
  </div>
</center>
<br>
